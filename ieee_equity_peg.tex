...
\begin{abstract}
The Calçotada Protocol turns seed capital—high-return Real World Assets traditionally reserved for venture capitalists—into performance-pegged tokens called Performance Equity Growth (PEG) tokens. These tokens track company valuation milestones and feature protocol-enforced buybacks inspired by convertible notes, giving retail investors structured exposure to the same upside potential that drives early-stage funding rounds. This document presents an early MVP implementation and lays the foundation for a broader, community-driven protocol. We invite collaborators—from financial engineers to DAO architects—to help shape this emerging standard and support its development through grants and other contributions. By channeling speculative energy toward real company growth, the Calçotada Protocol creates a new class of venture-backed assets and opens a powerful funding channel for traditional startups outside the crypto-native sphere.
\end{abstract}

\begin{IEEEkeywords}
Blockchain, Venture Capital, Equity Peg Token, Retail Investing, Tokenized Buyback, DAO, Open Specification, Real World Assets, Starup Funding
\end{IEEEkeywords}
...
For blockchain ecosystems, the protocol creates a new layer of composability by embedding algorithmic venture capital directly into smart contracts. By defining a transparent, programmable approach to seed funding, it opens the door to secondary financial products that can bring much-needed liquidity to the otherwise illiquid early-stage market. Traditional VC investments are often characterized by long holding periods, limited exit opportunities, and a lack of intermediaries, making it challenging for investors to realize returns before a company goes public or is acquired. The Calçotada Protocol aims to address these challenges by introducing mechanisms that facilitate earlier liquidity events, thereby enhancing the overall efficiency and accessibility of venture capital markets.
...
\section{The Calçotada Tradition: A Symbol of Collective Participation}

The Calçotada Protocol draws its name and inspiration from the Catalan tradition of \textit{la calçotada}, a communal feast recognized by UNESCO for its cultural significance. This tradition embodies collaboration, shared effort, and collective success—values mirrored in democratizing access to venture capital. The protocol is also directly linked to its sponsoring entity, \textit{The Calçotada Company}, and retaining these names reinforces the connection between the protocol, its community, and the company.

The protocol's dual-token architecture reflects this heritage:

\begin{itemize}
    \item \textbf{The NFT (Calçot-Coin)}: Represents governance and participation. Each NFT holder becomes part of the decision-making collective, with voting rights and access to benefits as the company and protocol grow. NFTs symbolize the community's engagement and long-term alignment with the protocol's success.

    \item \textbf{The RMSC Token (Romesco)}: Represents capital and returns. RMSC is freely available, tradeable, and designed to capture company performance while remaining detached from governance, ensuring that influence is not concentrated among large holders.
\end{itemize}

Retaining the Calçotada and Romesco names establishes a distinctive, culturally resonant identity, linking the protocol to \textit{The Calçotada Company}. This connection provides strategic value by ensuring brand consistency, clear ownership, and long-term visibility, supporting both the growth of the protocol and the sponsoring company.
